...
flag or using the v0 compatible options in Go integrations. When enabled, OPA
...
to migrate their Rego to be compatible with OPA v1.0 using the tooling available
to do so.
...
- `build`: supports Rego v0 syntax modules, use of `import rego.v1` is optional.
- `deps`: supports Rego v0 syntax modules, use of `import rego.v1` is optional.
- `check`*: supports Rego v0 syntax modules, use of `import rego.v1` is optional.
- `eval`: supports Rego v0 syntax modules, use of `import rego.v1` is optional.
- `exec`: supports Rego v0 syntax modules, use of `import rego.v1` is optional.
...
- `test`: supports Rego v0 syntax modules, use of `import rego.v1` is optional.
...
_both_ the current 0.x OPA version and OPA v1.0.
